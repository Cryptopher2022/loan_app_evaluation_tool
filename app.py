# Initial imports
# Import the csv library and the Path function from the pathlib library
import csv
...
def load_csv(csvpath):
    with open(csvpath, "r") as csvfile:
        ...
        for row in csvreader:
            data.append(row)
            print(f"This is the data returned", data)
    return data
print(f"This is the bank data", [data])
...
#
#Find monthly income or ask applicant
#determine monthly debt payments for the applicant
#constraint = No negative numbers allowed
#
#Determine the "value" of the asset or loan
#Determine the Loan amount proposed
#
#These will be pulled from a file in the Unsolved directory and in the data folder
#
